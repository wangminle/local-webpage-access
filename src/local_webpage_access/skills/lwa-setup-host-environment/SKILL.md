...
3. 用户操作系统：macOS / Linux（Ubuntu LTS 22.04/24.04/26.04、Debian Stable 12/13、Fedora 43/44）/ WSL2（Windows 仅作宿主，原生不支持）。
...
| Fedora 裸机 | 43/44（当前 + 前一稳定版滚动窗口） | Rawhide 与未纳入窗口的版本拒绝 |
