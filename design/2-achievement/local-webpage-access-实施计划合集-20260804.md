...
> **核对（2026-09-01）**：**七份计划的主交付均已落地**（见下「完成度速查」）。Task 11 中尚未实施的**路径相对化 / CLI 解耦**已从 2608 归档稿继续迁入 [`lwa-新增功能表-2609期.md`](../3-plans/lwa-新增功能表-2609期.md)（IMP-049 / IMP-050）。**跨盘 IMP-042.b 暂不开发、不迁入 2609 待办**（仍保留本节历史口径与预检 blocking 行为）。
...
| └ Task 11（P2）路径相对化 / CLI 与工作区解耦 | **未实现 → 已迁 2609** | IMP-049 / IMP-050 |
| └ Task 11（P2）跨盘 042.b | **暂不开发**（不迁 2609 待办） | 历史口径仍见本节 |
...
> **2026-09-01**：下列三项未实现；其中 IMP-049/050 的活动规划已继续迁入 [`lwa-新增功能表-2609期.md`](../3-plans/lwa-新增功能表-2609期.md)，IMP-042.b 仍维持暂不开发。2608 归档稿只保留历史转交记录。
...
> 补记入本合集（非原 `design/plans/` 七篇之一）。对应修订见已归档的 [`local-webpage-access-新增功能点2608.md`](./local-webpage-access-新增功能点2608.md) **§5 IMP-047 落地后修订**。task-list：`BUG-443` / `OPS-097`。
